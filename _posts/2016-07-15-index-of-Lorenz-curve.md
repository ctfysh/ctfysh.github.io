...
难以想想以上两种计算方法竟然是等效的。下面就对这种等效性进行说明。从“[对加权Gini系数的理解]({% post_url 2016-07-12-weighted-Gini-coeficient %})”中我们知道$$F(x_{h}^{\prime})=\sum_{i=0}^{h}w_{i}^{\prime}/\sum_{i=0}^{n}w_{i}^{\prime}$$和
